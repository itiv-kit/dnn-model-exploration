...
class FileHandler:
	...
	def write_configurationFile(self, mem_bitwidth, run_id, memory_bytes, tensor_length, bitwidth, scale, filename="configuration"):
		with open(self.dir_path+filename+'.txt', 'a') as f:
			f.write(int2bin( run_id, 32)+ '\n')
			f.write(int2bin(memory_bytes, 32)+ '\n')
			f.write(int2bin(tensor_length, 32)+ '\n')
			f.write(int2bin(bitwidth, 32)+ '\n')
			f.write('0011111101000000'+ '\n')
			f.write('0011111110101010'+ '\n')
			f.write(int2bin(tensor_length, 32)+ '\n')
